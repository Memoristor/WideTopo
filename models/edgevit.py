# coding=utf-8
# Original repo: https://github.com/saic-fi/edgevit
# Modified by @Memoristor
...
pretrained_cpt = {
    "edgevit_xxs": "models/pretrained/edgevitxxs_imagenet_acc73.47.pth",
    "edgevit_xs": "models/pretrained/edgevitxs_imagenet_acc76.44.pth",
    "edgevit_s": "models/pretrained/edgevits_imagenet_acc80.25.pth",
}

__all__ = ["EdgeVitXXS", "EdgeVitXS", "EdgeVitS"]
...
class EdgeVit(nn.Module):
    ...
    def __init__(
        self,
        depth: List[int] = [1, 2, 5, 3],
        img_size: Union[int, Tuple[int, int]] = 224,
        in_chans: int = 3,
        num_classes: int = 1000,
        embed_dim: List[int] = [48, 96, 240, 384],
        head_dim: int = 48,
        mlp_ratio: List[float] = [4.0, 4.0, 4.0, 4.0],
        qkv_bias: bool = True,
        ...
        norm_layer: Optional[Union[Callable, Type[nn.Module]]] = None,
        ...
        **kwargs,
        ...
        if representation_size:
            ...
            self.pre_logits = nn.Sequential(
                OrderedDict(
                    [("fc", nn.Linear(embed_dim[-1], representation_size)), ("act", nn.Tanh())]
                )
            )
        else:
    ...
    def init_weight(self):
        ...
        if os.path.exists(self.pretrained) and os.path.isfile(self.pretrained):
            weight_init.load_init(self, self.pretrained)
...
class EdgeVitXXS(EdgeVit):
    def __init__(
        self,
        depth: List[int] = [1, 1, 3, 2],
        img_size: Union[int, Tuple[int, int]] = 224,
        in_chans: int = 3,
        num_classes: int = 1000,
        embed_dim: List[int] = [36, 72, 144, 288],
        head_dim: int = 36,
        mlp_ratio: List[float] = [4.0, 4.0, 4.0, 4.0],
        qkv_bias: bool = True,
        qk_scale: Optional[float] = None,
        ...
        norm_layer: Optional[Union[Callable, Type[nn.Module]]] = None,
        sr_ratios: List[int] = [4, 2, 2, 1],
        pretrained=pretrained_cpt["edgevit_xxs"],
        **kwargs,
    ):
        super(EdgeVitXXS, self).__init__(
            depth,
            img_size,
            in_chans,
            num_classes,
...
class EdgeVitXS(EdgeVit):
    def __init__(
        ...
        norm_layer: Optional[Union[Callable, Type[nn.Module]]] = None,
        sr_ratios: List[int] = [4, 2, 2, 1],
        pretrained=pretrained_cpt["edgevit_xs"],
        **kwargs,
    ):
        super(EdgeVitXS, self).__init__(
            depth,
            img_size,
            in_chans,
            num_classes,
...
class EdgeVitS(EdgeVit):
    def __init__(
        ...
        norm_layer: Optional[Union[Callable, Type[nn.Module]]] = None,
        sr_ratios: List[int] = [4, 2, 2, 1],
        pretrained=pretrained_cpt["edgevit_s"],
        **kwargs,
    ):
        super(EdgeVitS, self).__init__(
            depth,
            img_size,
            in_chans,
            num_classes,
