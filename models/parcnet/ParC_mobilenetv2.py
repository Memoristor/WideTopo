...
class ParC_MobileNetV2(nn.Module):
    def __init__(
        ...
        if len(inverted_residual_setting) == 0 or len(inverted_residual_setting[0]) != 6:
            raise ValueError(
                "inverted_residual_gcc_setting should be non-empty "
        ...
        for t, c, n, s, gcc, r in inverted_residual_setting:
            ...
            for i in range(n):
                ...
                if i < gcc:
                    ...
                    features.append(
                        InvertedResidual_parc(
                            input_channel,
                            output_channel,
                            stride,
                            expand_ratio=t,
                            norm_layer=norm_layer,
                            global_kernel_size=r,
...
@register_model
def parc_mv2(pretrained: bool = False, progress: bool = True, **kwargs: Any):
    """
...
class ParCMobileNetV2(ParC_MobileNetV2):
    """
    Constructs a MobileNetV2 architecture from
    `"MobileNetV2: Inverted Residuals and Linear Bottlenecks" <https://arxiv.org/abs/1801.04381>`_.
    ...
    def __init__(self, **kwargs):
        super(ParCMobileNetV2, self).__init__(**kwargs)
