...
class ResNet(nn.Module):
    def __init__(
        ...
        self.layer3 = self._make_mix_layer(
            block,
            256,
            layers[2],
            parc_insert_locs[2],
        ...
        self.layer4 = self._make_mix_layer(
            block,
            512,
            layers[3],
            parc_insert_locs[3],
...
def parc_resnet(
    ...
    **kwargs: Any,
    ...
    model = ResNet(block, layers, gcc_bs_indices, **kwargs)
    return model


@register_model
def parc_res50(pretrained: bool = False, progress: bool = True, **kwargs: Any):
    model = parc_resnet(Bottleneck, [3, 4, 6, 3], [3, 4, 3, 2], **kwargs)
    return model


class ParCResNet50(ResNet):
    def __init__(self, pretrained: bool = False, progress: bool = True, **kwargs: Any):
        super(ParCResNet50, self).__init__(Bottleneck, [3, 4, 6, 3], [3, 4, 3, 2], **kwargs)
