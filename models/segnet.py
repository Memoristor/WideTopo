...
from torchvision.models.vgg import VGG16_Weights, VGG19_BN_Weights
...
class SegNetVGG16(nn.Module):
    def __init__(self, num_class):
        ...
        self.enc5 = nn.Sequential(*features[24:])
        ...
        self.dec1 = _DecoderBlock(128, num_class, 2)
...
class SegNetVGG19BN(nn.Module):
    def __init__(self, num_class):
        super(SegNetVGG19BN, self).__init__()

        vgg = models.vgg19_bn(weights=VGG19_BN_Weights.IMAGENET1K_V1)
