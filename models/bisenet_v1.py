#!/usr/bin/python
# -*- encoding: utf-8 -*-
# Original code: https://github.com/CoinCheung/BiSeNet/blob/master/lib/models/bisenetv1.py
...
backbone_url = {
    "cityscapes": "https://github.com/CoinCheung/BiSeNet/releases/download/0.0.0/model_final_v1_city_new.pth",
    "ade20k": "https://github.com/CoinCheung/BiSeNet/releases/download/0.0.0/model_final_v1_ade20k.pth",
    "coco": "https://github.com/CoinCheung/BiSeNet/releases/download/0.0.0/model_final_v1_coco_new.pth",
}
...
class BiSeNetV1(nn.Module):
    def __init__(self, n_classes, aux_mode="train", pretrained_dataset="cityscapes"):
