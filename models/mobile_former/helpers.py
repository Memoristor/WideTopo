...
from timm.models.features import FeatureHookNet, FeatureListNet
from timm.models.hub import download_cached_file, has_hf_hub, load_state_dict_from_hf
...
def build_model_with_cfg(
    ...
    **kwargs,
    ...
    num_classes_pretrained = (
        0 if features else getattr(model, "num_classes", kwargs.get("num_classes", 1000))
    )
    if pretrained:
